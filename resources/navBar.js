...
var navBarHTML = '<div id="mySidenav" class="sidenav"> <a href="#" class="closebtn" onclick="closeNav()">&times;</a> <a href="' + baseUrl + '">Pagina Principal</a> <a href="' + baseUrl + '/lugares">Lugares</a><a href="' + baseUrl + '/lugares/sancristobal"><div class="navBarPadding">La Colina de San Cristóbal</div></a><a href="' + baseUrl + '/lugares/sanlucia"><div class="navBarPadding">La Colina de San Lucia</div></a><a href="' + baseUrl + '/itinerarios">Itinerarios</a><a href="' + baseUrl + '/conclusion">Conclusion</a></div>';
